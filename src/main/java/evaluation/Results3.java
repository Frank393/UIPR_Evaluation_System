...
public class Results3 {
	public static void main(String args[]) throws Exception {  
	 ...
	 //Creating a PdfDocument object   
		...
		paragraph6.add("RANGO CATEDRÁTICO ").setTextAlignment(TextAlignment.CENTER);
		...
		table.addCell(new Cell().add("Catedratico  Valencia (63%)").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setBorderTop(new SolidBorder(2)).setBorderBottom(new SolidBorder(2)));          
		...
		table.addCell(new Cell().add("13").setTextAlignment(TextAlignment.CENTER).setPaddingTop(10).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
		table.addCell(new Cell().add("" + vr.CalidadDocente(i, In.gettipo())[0]).setTextAlignment(TextAlignment.CENTER).setPaddingTop(10).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));  
		...
		table.addCell(new Cell().add("5").setTextAlignment(TextAlignment.CENTER).setPaddingTop(20).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
		table.addCell(new Cell().add("PO1").setTextAlignment(TextAlignment.CENTER).setPaddingTop(20).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));  
		...
		table.addCell(new Cell().add("Catedratico  Valencia (9%)").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));          
		...
		table.addCell(new Cell().add("2").setTextAlignment(TextAlignment.CENTER).setPaddingTop(20).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
		table.addCell(new Cell().add("PO1").setTextAlignment(TextAlignment.CENTER).setPaddingTop(20).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));  
		...
		table.addCell(new Cell().add("2").setTextAlignment(TextAlignment.CENTER).setPaddingTop(50).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
		table.addCell(new Cell().add("PO1").setTextAlignment(TextAlignment.CENTER).setPaddingTop(50).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));  
		...
		table.addCell(new Cell().add("Catedratico  Valencia (2%)").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));          
		table.addCell(new Cell().add("Puntuacion Obtenida").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));    
		...
		table.addCell(new Cell().add("5").setTextAlignment(TextAlignment.CENTER).setPaddingTop(10).setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
		...
		table.addCell(new Cell().add("4").setTextAlignment(TextAlignment.CENTER).setPaddingTop(20).setBorder(Border.NO_BORDER));       
		...
		table2.addCell(new Cell().add("63%").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setPaddingTop(20));       
		...
		table2.addCell(new Cell().add("9%").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setPaddingTop(5));       
		...
		table2.addCell(new Cell().add("14%").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setPaddingTop(10));       
		table2.addCell(new Cell().add("____________________________________").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setPaddingTop(10));  
		...
		table2.addCell(new Cell().add("12%").setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER).setPaddingTop(10).setBorderBottom(new SolidBorder(1)));       
		...
		paragraph8.add("El/la profesor/a ________________________________________ cumple con los criterios requeridos para el Rango de Catedrático ,  según consta en la Parte II, 2.2.3 del Manual de Facultad y "
		...
		paragraph8.add("\nEste comité recomienda en forma ____________________ que se le otorgue a el/la _________________ el ascenso en rango de Catedrático/a Auxiliar a Catedrático/a /a. \n\n").setTextAlignment(TextAlignment.LEFT);///////////////////////////////
		...
		doc.close();
		System.out.println("PDF3 created successfully..");   
	}     
}
