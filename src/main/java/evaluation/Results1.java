...
public class Results1 {
	public static void main(String args[]) throws Exception {           
	      ...
	      table.addCell(new Cell().add("b. Habilidad para organizar el contenido y presentarlo en forma clara, lógica").setBorder(Border.NO_BORDER).setBorderBottom(new SolidBorder(1)));       
